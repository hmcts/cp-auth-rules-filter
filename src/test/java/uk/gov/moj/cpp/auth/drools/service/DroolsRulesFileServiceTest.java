package uk.gov.moj.cpp.auth.drools.service;
...
import static uk.gov.moj.cpp.auth.drools.service.DroolsRulesFileService.DROOLS_RESOURCE_FOLDER;
...
class DroolsRulesFileServiceTest {
    ...
    void local_rules_file_should_get_path_correctly() {
        String localFilename = "/projects/cp-springboot-auth-rules-filter/build/resources/test/drools-test/uk/gov/moj/cpp/auth/demo/test-rules.drl";
        assertThat(fileService.getRulesFilePackageFolder(localFilename)).isEqualTo("uk/gov/moj/cpp/auth/demo/test-rules.drl");
    }
